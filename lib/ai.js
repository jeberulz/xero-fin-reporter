...
Please provide a well-structured, data-driven answer. Use this format:

1. Start with a brief overview paragraph
2. If applicable, break down your analysis into numbered sections with clear headings like:
   - 1. Revenue Analysis: [details]
   - 2. Cost Analysis: [details] 
   - 3. Key Insights: [details]
3. Use specific numbers and percentages
4. If data is limited, clearly explain what additional information would be helpful

Make your response clear, professional, and easy to read with logical structure.`;
    ...
    const completion = await openai.chat.completions.create({
      ...
      messages: [
        {
          role: "system",
          content: "You are an expert financial analyst. Provide structured, well-formatted responses with clear headings and specific data points. Break complex analyses into numbered sections with descriptive titles."
        },
        {
          role: "user",
          content: prompt
